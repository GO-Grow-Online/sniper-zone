...
if ($result->num_rows > 0) : ?>
    <table class="table">
        ...
        <tr class="table-row <?php if($row['sending_success']) : ?> table-row-mailSucces<?php endif; ?>">
